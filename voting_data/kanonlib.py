...
def MySQLcommand(command,host='salmon-dance.cruftlabs.com',user=username,pw=password,database='cambridge_voting_records',port_no=3306):
    conn = None
...
def MySQLquery(command,host='salmon-dance.cruftlabs.com',user=username,pw=password,database='cambridge_voting_records',port_no=3306):
    conn = None
